...
## Current blocker
`02.01` through `02.19` are accepted on the PR branch with real sequential evidence. Corrected 02.19 exact-head GitHub-hosted Windows run `32669585231`, job `97268208441`, artifact `9501114320`, artifact digest `sha256:78f0e94c266a0837f1f89df9a7b758226438d93a0f566c72565cacb02132ac68`, and evidence digest `sha256:808f06539d0d1f6b816b9030939bb883fc3ed6c54a33dadecb8c9fa09eca4e85` passed on source `bd1687c0e04e1ba022cd8d02b78a15546ebb9290`. Acceptance proved authenticated start/write/read-wait/status/stop/list/remove, separate stdout/stderr, bounded long-poll and ring-buffer output, genuine 192 KiB sub-limit blocked stdin write, unrelated-session status in 75 ms, same blocked-session stop in 52 ms, direct/junction/program containment, valid 26-event audit chain and verified cleanup. The earlier green 02.19 artifact was rejected after independent inspection showed its writer had exceeded the 256 KiB input bound rather than genuinely backpressuring; only the corrected evidence is accepted. Required same-head Governance, PKG-02 sequence, 02.02, 02.08, 02.16, 02.17 and 02.18 regressions also passed. PR-branch projected PKG-02 progress is `19/27 = 70.37%`; projected next task is `02.20` Interactive PTY/ConPTY session lifecycle. Canonical `main` remains `18/27 = 66.67%`, active `02.19`, until this branch is final-head re-certified and explicitly authorized for merge. Do not implement or count `02.20` before integration and a fresh canonical re-read.
