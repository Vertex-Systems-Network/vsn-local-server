...
## Current blocker
`02.01` through `02.17` are DONE with real sequential acceptance evidence. `02.17` exact-head GitHub-hosted Windows run `32660580865`, job `97246023900`, artifact `9498748049`, artifact digest `sha256:ab41e2281fcef0944a7b9cf765e11b9c01bcc1903046b33d2197a5fffc0ccf86`, and evidence digest `sha256:1de8b4831b8ee387617259bbd851404194b05fc96ef850d1d0c5ea35b9b2eeb6` passed on accepted source head `8d515575d5957f94531375214705b0ad031fe79d`. Acceptance verified exact offset and 512 KiB chunk bounds, status/abort/restart, multi-chunk resume, finalize and Agent SHA-256 equality, chunked-download reconstruction and per-chunk digests, direct and Windows-junction containment, unsafe transfer-id rejection, interrupted-replace recovery, valid audit chain and verified cleanup. PKG-02 is `17/27 = 62.96%`. Execute `02.18` Bounded direct terminal execution next; do not count `02.19` or later before `02.18` is genuinely verified.
