...
9. State reconciliation increments only 03.03 while preserving the independent live state of sibling 03.02.
...
- `03.03=DONE`;
- total PKG-03 `done` increments by exactly one from the then-canonical sibling state;
- 03.04 and 03.05 remain READY;
- 03.02 is preserved exactly as canonical;
- cursor is the lowest remaining READY/IN_PROGRESS task;
