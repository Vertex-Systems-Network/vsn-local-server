...
git rm -f -- 'scripts/self-hosted/pkg02-0209-reconcile.ps1'
...
git add $cert $status $readme $planPath
...
throw 'canonical reconciliation committed; workflow will be restored by repository controller'
