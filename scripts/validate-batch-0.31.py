#!/usr/bin/env python3
"""Offline/source integration gate for VSN 0.31.0. Native compilation remains a separate P30 evidence gate."""
...
try:
 ...
 if d.get('product_version')!='0.31.0': errors.append('roadmap product_version != 0.31.0')
...
for p in sorted(ROOT.rglob('Cargo.toml')):
 try:
  ...
  if 'package' in d:
   ...
   if v not in ('0.31.0','0.0.0'): errors.append(f'package version drift {p.relative_to(ROOT)}={v}')
  tables=[]
...
required={
 ...
 'apps/cli/src/main.rs':['0.31.0','command_catalog','completion_script','diagnostics','commands'],
 ...
 'cloud/control-plane/src/main.rs':['0.31.0','/v1/admin/vault/rotate','loaded_key_ids','active_key_id','delete_fleet_group','delete_environment','validate_fleet'],
 'cloud/control-plane/src/main.rs':['0.31.0','/v1/admin/control/validate','/v1/admin/iam/validate','/v1/admin/security/validate','validate_control_plane','validate_iam','validate_security'],
 ...
 'docs/BATCH-0.31.md':['P30 Runner-Pack Execution','98.9032%'],
 'docs/source-closure-0.31.md':['P0–P29','P30'],
 'scripts/control-plane-dr.py':['pg_dump','pg_restore','RESTORE_CONTROL_PLANE'],
 'scripts/source-readiness.py':['SOURCE_CLOSED','P30'],
 'packaging/linux/build-deb.sh':['0.31.0'],
 'docs/STATUS-0.31.md':['98.9032%','0/21','runner packs'],
 '.github/workflows/ci.yml':['validate-batch-0.31.py'],
 '.github/workflows/release-gate.yml':['validate-batch-0.31.py'],
}
...
extra_required={
 ...
 'docs/BATCH-0.31.md':['P30','evidence'],
 'docs/source-closure-0.31.md':['P0–P29','P30'],
 'docs/STATUS-0.31.md':['99%','30/30','P30'],
}
...
for rel,needles in {
 ...
 'docs/release-evidence-current.json':['"schema_version": 3','"product_version": "0.31.0"','"candidate_id"'],
 '.github/workflows/release-gate.yml':['release-evidence-current.json','scripts/p30-fragment.py'],
 '.github/workflows/release-signing.yml':['signing-evidence','0.31.0'],
}.items():
 p=ROOT/rel
...
extra_027={
 ...
 'docs/BATCH-0.31.md':['candidate_id','different source candidates'],
 'docs/STATUS-0.31.md':['30/30','0/21'],
}
...
try:
 ...
 if packs.get('product_version')!='0.31.0': errors.append('runner pack product_version != 0.31.0')
 covered=[]
