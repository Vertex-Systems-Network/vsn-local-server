...
required={
 ...
 'docs/BATCH-0.29.md':['Candidate-Bound P30 Certification','98.9032%'],
 'docs/source-closure-0.29.md':['P0–P29','P30'],
 ...
 'docs/STATUS-0.29.md':['98.9032%','0/21'],
...
extra_required={
 ...
 'docs/BATCH-0.29.md':['P30','evidence'],
 'docs/source-closure-0.29.md':['P0–P29','P30'],
 'docs/STATUS-0.29.md':['99%','30/30','P30'],
}
...
for rel,needles in {
 ...
 'docs/release-evidence-current.json':['"schema_version": 3','"product_version": "0.29.0"','"candidate_id"'],
 '.github/workflows/release-gate.yml':['release-evidence-current.json','VERSION=$(cat VERSION)'],
...
extra_027={
 ...
 'docs/BATCH-0.29.md':['candidate_id','different source candidates'],
 'docs/STATUS-0.29.md':['30/30','0/21'],
}
...
for rel,needles in {
 ...
 '.github/workflows/release-gate.yml':['release-candidate.py id','toolchain: 1.97.0'],
 '.github/workflows/security-nightly.yml':['release-candidate.py id'],
 '.github/workflows/release-signing.yml':['release-candidate.py id'],
