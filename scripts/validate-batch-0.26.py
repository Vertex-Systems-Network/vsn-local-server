#!/usr/bin/env python3
"""Offline/source integration gate for VSN 0.26.0. Native compilation remains a separate P30 evidence gate."""
...
try:
 ...
 if d.get('product_version')!='0.26.0': errors.append('roadmap product_version != 0.26.0')
...
for p in sorted(ROOT.rglob('Cargo.toml')):
 try:
  ...
  if 'package' in d:
   ...
   if v not in ('0.26.0','0.0.0'): errors.append(f'package version drift {p.relative_to(ROOT)}={v}')
  tables=[]
...
required={
 ...
 'apps/cli/src/main.rs':['0.26.0','command_catalog','completion_script','diagnostics','commands'],
 ...
 'cloud/control-plane/src/main.rs':['0.26.0','/v1/admin/vault/rotate','loaded_key_ids','active_key_id','delete_fleet_group','delete_environment','validate_fleet'],
 'cloud/control-plane/src/main.rs':['0.26.0','/v1/admin/control/validate','/v1/admin/iam/validate','/v1/admin/security/validate','validate_control_plane','validate_iam','validate_security'],
 ...
 'docs/BATCH-0.26.md':['P30 certification sprint','evidence-driven'],
 'docs/source-closure-0.26.md':['P0–P29','P30'],
 'scripts/control-plane-dr.py':['pg_dump','pg_restore','RESTORE_CONTROL_PLANE'],
 'scripts/source-readiness.py':['SOURCE_CLOSED','P30'],
 'packaging/linux/build-deb.sh':['0.26.0'],
 'packaging/macos/build-pkg.sh':['0.26.0'],
 'packaging/windows/build-msi.ps1':['0.26.0'],
 'docs/STATUS-0.26.md':['99%'],
 '.github/workflows/ci.yml':['validate-batch-0.26.py'],
 '.github/workflows/release-gate.yml':['validate-batch-0.26.py'],
}
...
# 0.26 source-closure anchors for P23/P25
extra_required={
 ...
 'docs/BATCH-0.26.md':['P30','evidence'],
 'docs/source-closure-0.26.md':['P0–P29','P30'],
 'docs/STATUS-0.26.md':['99%','30/31','P30'],
}
...
for rel,needles in {
 ...
 'scripts/p30-progress.py':['66+round(34*cert/100)','overall_completion_percent'],
 ...
 'docs/release-evidence-current.json':['"schema_version": 2','"product_version": "0.26.0"'],
 '.github/workflows/release-gate.yml':['release-evidence-current.json','0.26.0'],
 '.github/workflows/release-signing.yml':['signing-evidence','0.26.0'],
}.items():
 p=ROOT/rel
