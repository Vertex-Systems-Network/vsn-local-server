...
- Current genuine PKG-02 progress: `26/27 = 96.30%`.
- `02.01` through `02.26` have genuine sequential acceptance evidence recorded in the canonical tracker.
...
- No PKG-03 work may count until `02.27` genuinely completes PKG-02.
...
<!-- Canonical PKG-02 machine state: 26/27, 02.27 active; query live main SHA at execution time -->
